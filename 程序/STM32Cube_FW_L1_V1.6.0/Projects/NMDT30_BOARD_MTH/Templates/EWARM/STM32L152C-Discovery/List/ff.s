...
//    Endian       =  little
//    Source file  =  
//        E:\应用\电路图\NMDT30\数据资料\固件库\stm32cubel1\stm32cubel1\STM32Cube_FW_L1_V1.4.0\Middlewares\Third_Party\FatFs\src\ff.c
//    Command line =  
//        E:\应用\电路图\NMDT30\数据资料\固件库\stm32cubel1\stm32cubel1\STM32Cube_FW_L1_V1.4.0\Middlewares\Third_Party\FatFs\src\ff.c
...
//    List file    =  
//        E:\应用\电路图\NMDT30\数据资料\固件库\stm32cubel1\stm32cubel1\STM32Cube_FW_L1_V1.4.0\Projects\NMDT30_BOARD\Templates\EWARM\STM32L152C-Discovery\List\ff.s
//
///////////////////////////////////////////////////////////////////////////////
...
??create_name_21:
        UXTB     R6,R6            ;; ZeroExt  R6,R6,#+24,#+24
        CMP      R6,#+65
        BLT.N    ??create_name_22
        UXTB     R6,R6            ;; ZeroExt  R6,R6,#+24,#+24
        CMP      R6,#+91
        BGE.N    ??create_name_22
        ORRS     R5,R5,#0x2
        B.N      ??create_name_23
??create_name_22:
        UXTB     R6,R6            ;; ZeroExt  R6,R6,#+24,#+24
        CMP      R6,#+97
        BLT.N    ??create_name_23
        UXTB     R6,R6            ;; ZeroExt  R6,R6,#+24,#+24
        CMP      R6,#+123
        BGE.N    ??create_name_23
        ORRS     R5,R5,#0x1
        SUBS     R6,R6,#+32
??create_name_23:
        STRB     R6,[R11, R7]
...
// 14 222 bytes in section .text
// 
// 14 222 bytes of CODE  memory
