...
extern unsigned char const HZ_ZongFuShe[];     /* 总辐射 */
extern unsigned char const HZ_GuangHe[];       /* 光合 */
extern unsigned char const HZ_Guang_He[];      /* 光  合 */
extern unsigned char const HZ_QiYa[];          /* 气压 */
...
extern unsigned char const HZ_FenZhong[];      /* 分钟 */
