...
void ZDO_StartDevice( byte logicalType, devStartModes_t startMode, byte beaconOrder, byte superframeOrder )
{
  ...
  if ( ZG_BUILD_COORDINATOR_TYPE && logicalType == NODETYPE_COORDINATOR )//µ±Éè±¸×÷ÎªÐ­µ÷Æ÷
  {
    if ( startMode == MODE_HARD )
    {
      devState = DEV_COORD_STARTING;
      //ÏòÍøÂç²ã·¢ËÍÍøÂçÐÎ³ÉÇëÇó¡£µ±ÍøÂç²ãÖ´ÐÐNLME_NetworkFormationRequest()½¨Á¢ÍøÂçºó£¬½«¸øÓèZDO²ã·´À¡ÐÅÏ¢
